...
*/
            ...
            createServerToken: function(params) {
                console.log(this.ws)
        ...
        var LM = {
            ...
            'connect': function(t) {
                ...
                this.integrity=t.indexOf('agar.io')>-1
        ...
        'sendTokenForBots': function () {	  
          ...
          //this.playerNick = nick;    
            ...
            'handleMessage': function(data) {
                ...
                switch (54 == opcode && (opcode = 53), opcode) {
                    ...
                    case 102:
                        ...
                        case 16:
                            this.updateCellsAdequate(new buffer.Buffer(data.buffer), e);
                            break;
                        case 64:
                            var msg = new buffer.Buffer(data.buffer)
                            this.viewMinX = msg.readDoubleLE(e);
                            e += 8;
                            this.viewMinY = msg.readDoubleLE(e);
                            e += 8;
                            this.viewMaxX = msg.readDoubleLE(e);
                            e += 8;
                            this.viewMaxY = msg.readDoubleLE(e);
            ...
            'setMapOffset': function(t, e, i, s) {
                if (!this.integrity || i - t > 14000 && s - e > 14000) {
            ...
            'updateCells': function(t, i) {
                ...
                for (a = 0;;) {
                    ...
                    var LM = 1 & d,
                        isFood = 1 & f,
                        cell = null;
                    this.indexedCells.hasOwnProperty(l) ? (cell = this.indexedCells[l],
                            m && (cell.color = m)) :
                        ((cell = new ogarbasicassembly(l, h, c, u, m, isFood, LM, false, defaultmapsettings.shortMass, defaultmapsettings.virMassShots)).time = this.time,
                            isFood ? this.food.push(cell) :
                            (LM && defaultmapsettings.virusesRange && this.viruses.push(cell),
                                this.cells.push(cell),
                                -1 != this.playerCellIDs.indexOf(l) && -1 == this.playerCells.indexOf(cell) && (cell.isPlayerCell = true,
                                    this.playerColor = m, this.playerCells.push(cell))),
                            this.indexedCells[l] = cell),
                        cell.isPlayerCell && (y = this.playerNick),
                        y && (cell.targetNick = y),
                        cell.targetX = h,
                        cell.targetY = c,
                        cell.targetSize = u,
                        ...
                        cell.isVirus = LM,
                        //
                        cell.isOwnEjected = isOwnEjected,
                        cell.isOtherEjected = isOtherEjected,
                        //
                        g && (cell.skin = g),
                ...
                for (o = t.readUInt16LE(i), i += 2, a = 0; a < o; a++) {
                    l = t.readUInt32LE(i);
                    i += 4, (cell = this.indexedCells[l]) && cell.removeCell();
                }
                //Sonia7
            ...
            updateCellsAdequate: function(view, offset) {
                const encode = () => {
                    for (var text = '';;) {
                ...
                for (length = 0;;) {
                    ...
                    if (this.indexedCells.hasOwnProperty(id)) {
                        ...
                        cell = new ogarbasicassembly(id, x, y, size, color, isFood, isVirus, false, defaultmapsettings.shortMass, defaultmapsettings.virMassShots);
                        cell.time = this.time;
                        if (!isFood) {
